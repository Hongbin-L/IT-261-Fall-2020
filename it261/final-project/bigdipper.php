...
include('includes/daily-header-fp.php');
?>
<?php
...
<p><?php echo $content; ?></p>
         ...
         <aside>
            ...
            <ul>
                <li><a href="bigdipper.php?today=Monday">Monday</a></li>
                <li><a href="bigdipper.php?today=Tuesday">Tuesday</a></li>
                <li><a href="bigdipper.php?today=Wednesday">Wednesday</a></li>
                <li><a href="bigdipper.php?today=Thursday">Thursday</a></li>
                <li><a href="bigdipper.php?today=Friday">Friday</a></li>
                <li><a href="bigdipper.php?today=Saturday">Saturday</a></li>
                <li><a href="bigdipper.php?today=Sunday">Sunday</a></li>
            </ul>
        </aside>
