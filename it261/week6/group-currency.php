...
<body>
    ...
    if($total >= 750) {
        echo '<html class="background-image: happy">';
         ?>
            ...
            <?php
                ...
                echo '<h1 class="center" style="color:green;">Life is good</h1>';
    }   
    
        elseif($total < 750) {
            echo '<html class="background-image: rainy">';
         ?>
            <div class="box"> 
            <?php
                echo '<h2>Thank you, '.$name.' for filling out form! Your money will be wired to '.$bank.' within 24 hours</h2>';
                echo '<p>'.$name.', you now have $'.$total_f.' American Dollars!</p>';
                echo '<p>We will be get back to tou via your email: '.$email.'</p>';
                echo '<h1 class="center" style="color:red;">Hmmm... could be better...</h1>';
    }   
    }
